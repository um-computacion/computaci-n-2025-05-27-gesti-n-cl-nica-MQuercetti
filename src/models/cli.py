...
from models.pacientes import Pacientes_de_Clinica as Pacientes
from models.medico import Medico
from models.especialidad import Especialidad
from models.NotFound import (
...
class CLI:
    ...
    def ejecutar(self):
        print("Bienvenido al Sistema de gestion de datos de la Clínica!")
    ...
    def agregar_paciente(self):
        ...
        try:
            ...
            paciente = Pacientes(nombre, dni, fecha_nacimiento)
